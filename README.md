...
# [Project Title — lab-1-git-workflows]
...
This pull request sets up the project environment for the hospital admission analysis project. I added the required dependencies (pandas and matplotlib) to requirements.txt, expanded .gitignore to exclude the .venv/ directory, and created a local Python virtual environment.
